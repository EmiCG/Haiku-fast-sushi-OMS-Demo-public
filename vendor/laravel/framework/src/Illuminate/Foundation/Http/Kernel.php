...
class Kernel implements KernelContract
{
    ...
    protected $middleware = [  
       ...
       \Illuminate\Foundation\Http\Middleware\ValidatePostSize::class,
        ...
        \Illuminate\Http\Middleware\HandleCors::class, // Manejo de CORS\
        \Illuminate\Http\Middleware\TrustProxies::class,
        \Illuminate\Foundation\Http\Middleware\VerifyCsrfToken::class, // Verificación de CSRF
    ];
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \Illuminate\Foundation\Http\Middleware\VerifyCsrfToken::class, // Middleware CSRF
