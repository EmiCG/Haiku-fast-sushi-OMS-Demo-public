...
class HandleCors
{
    ...
    /**
     * The default CORS allowed methods.
     *
     * @var array
     */
    protected $defaultAllowedMethods = ['*'];

    /**
     * The default CORS allowed origins.
     *
     * @var array
     */
    ...
    /**
     * The default CORS allowed headers.
     *
     * @var array
     */
    protected $defaultAllowedHeaders = ['Content-Type', 'X-CSRF-TOKEN', 'Authorization', 'X-Requested-With'];
